...
| [P3 production-baseline P&L proposal](https://github.com/Bigbadboybob/predictionTrading/blob/e616b6dea/analysis/backtestIteration/docs/swarm-pnl/PROPOSAL.md) | PnL-Scout; Swarm-Gardener coordinates | `e616b6dea` proposal and notes fully personally read | [CM review](../reviews/2026-09-10-p3-production-pnl-review.md): evidence-scope and consistency revisions requested; no implementation selected |
