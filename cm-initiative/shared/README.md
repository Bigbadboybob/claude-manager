...
| [Proposal task roster](https://github.com/Bigbadboybob/predictionTrading/blob/a83f8ddc3/agent_docs/swarm-focused-design/LANES.md) | Swarm-Gardener | predictionTrading `a83f8ddc3` snapshot; live roster on its hub branch | Exact tasks, sessions, owned paths, worktree modes, collaboration pairs, and launch groups |
