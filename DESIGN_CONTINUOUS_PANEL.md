...
- **`◇` dim** — idle activity; stage and next action identify who acts next. Worker DMs can wake the parent for review before its next scheduled scan. Idle does not mean approved.
