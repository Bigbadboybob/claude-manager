...
### Phase 12a: `~/.cm/hosts.toml` schema + loader [feedback]
...
### Phase 12b: `HostId` field on session-bearing types [feedback]
...
### Phase 12c: Per-host RPC connection pool (local-only) [feedback]
...
### Phase 12d: SSH-unix transport [feedback]
...
### Phase 12e: `A-H` keybind + sidebar host grouping [feedback]
...
### Phase 12f: Remote-host packaging (daemon side) [feedback]
...
### Phase 12g: cm-manager VM prep + named A_smoke acceptance gate [feedback]
...
### Phase 12h: TLS-TCP transport (follow-up) [feedback]
